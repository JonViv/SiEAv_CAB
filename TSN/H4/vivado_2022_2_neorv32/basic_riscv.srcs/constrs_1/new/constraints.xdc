...
set_property PACKAGE_PIN AA11 [get_ports {uart0_txd_o}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {uart0_rxd_i}];  # "JA3"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {pwm_o[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {pwm_o[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {pwm_o[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {pwm_o[3]}];  # "LD3"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {rstn_i}];  # "BTNC"
