...
################################################################
# This is a generated script based on design: h2_blockDesign
#
...
# source h2_blockDesign_script.tcl
...
set design_name h2_blockDesign
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AudioCodec, and set properties
  set AudioCodec [ create_bd_cell -type ip -vlnv ehu.es:user:audio_ip:1.1 AudioCodec ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {47.619049} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports sw] [get_bd_intf_pins switches/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AudioCodec/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net AC_GPIO1_0_1 [get_bd_ports AC_GPIO1] [get_bd_pins AudioCodec/AC_GPIO1]
  connect_bd_net -net AC_GPIO2_0_1 [get_bd_ports AC_GPIO2] [get_bd_pins AudioCodec/AC_GPIO2]
  connect_bd_net -net AC_GPIO3_0_1 [get_bd_ports AC_GPIO3] [get_bd_pins AudioCodec/AC_GPIO3]
  connect_bd_net -net Net [get_bd_ports AC_SDA] [get_bd_pins AudioCodec/AC_SDA]
  connect_bd_net -net audio_ip_0_AC_ADR0 [get_bd_ports AC_ADR0] [get_bd_pins AudioCodec/AC_ADR0]
  connect_bd_net -net audio_ip_0_AC_ADR1 [get_bd_ports AC_ADR1] [get_bd_pins AudioCodec/AC_ADR1]
  connect_bd_net -net audio_ip_0_AC_GPIO0 [get_bd_ports AC_GPIO0] [get_bd_pins AudioCodec/AC_GPIO0]
  connect_bd_net -net audio_ip_0_AC_MCLK [get_bd_ports AC_MCLK] [get_bd_pins AudioCodec/AC_MCLK]
  connect_bd_net -net audio_ip_0_AC_SCK [get_bd_ports AC_SCK] [get_bd_pins AudioCodec/AC_SCK]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AudioCodec/clk_100] [get_bd_pins AudioCodec/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins switches/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins AudioCodec/clk_48] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AudioCodec/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins switches/s_axi_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AudioCodec/S00_AXI/S00_AXI_reg] SEG_audio_ip_0_S00_AXI_reg
