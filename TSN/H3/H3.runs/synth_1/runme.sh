...
HD_PWD='D:/CAB/TSN/H3/H3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h2_blockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h2_blockDesign_wrapper.tcl
