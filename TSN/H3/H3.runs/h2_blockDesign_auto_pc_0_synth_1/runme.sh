...
HD_PWD='E:/CAB/TSN/H3/H3.runs/h2_blockDesign_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h2_blockDesign_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h2_blockDesign_auto_pc_0.tcl
