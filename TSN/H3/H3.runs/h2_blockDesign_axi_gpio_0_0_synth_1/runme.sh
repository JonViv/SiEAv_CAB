...
HD_PWD='E:/CAB/TSN/H2/H2.runs/h2_blockDesign_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h2_blockDesign_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h2_blockDesign_axi_gpio_0_0.tcl
