...
HD_PWD='D:/CAB/TSN/H2/H2.runs/h2_blockDesign_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h2_blockDesign_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h2_blockDesign_processing_system7_0_0.tcl
