...
HD_PWD='D:/CAB/TSN/H2/H2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log h2_blockDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source h2_blockDesign_wrapper.tcl -notrace
