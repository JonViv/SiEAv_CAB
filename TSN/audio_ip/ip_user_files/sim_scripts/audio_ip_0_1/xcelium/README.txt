...
#
# Generated by export_simulation on Tue Apr 01 16:25:46 +0200 2025
#
################################################################################
...
'-reset_run' switch to the './audio_ip_0.sh' script.

./audio_ip_0.sh -reset_run
...
./audio_ip_0.sh -noclean_files

For more information on the script, please type './audio_ip_0.sh -help'.
