...
HD_PWD='e:/cab/tsn/audio_ip/ip_repo/edit_audio_ip_v1_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_ip_v1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_ip_v1_1.tcl
