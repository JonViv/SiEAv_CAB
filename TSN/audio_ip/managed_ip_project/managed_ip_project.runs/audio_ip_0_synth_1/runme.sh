...
HD_PWD='E:/CAB/TSN/audio_ip/managed_ip_project/managed_ip_project.runs/audio_ip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_ip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_ip_0.tcl
